...
void upArrow() {
    unsigned char up[8] = {0x00, 0x20, 0x60, 0xFF, 0xFF, 0x60, 0x20, 0x00};
    display(up);
}

void leftArrow() {
    unsigned char left[8] = {0x18, 0x3C, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x18};
    display(left);
}

void rightArrow() {
    unsigned char right[8] = {0x18, 0x18, 0x18, 0x18, 0x18, 0x7E, 0x3C, 0x18};
    display(right);
}
